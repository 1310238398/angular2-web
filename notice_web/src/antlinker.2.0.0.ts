...
// antlinker.isPC = true; //pc版本自定义useragent

// antlinker.version = "2.0.0-dev";

declare var webkit : any;
declare var androidAntLinker : any;
...
export class GetEffectiveWebkey {
    invoke: any = function(request) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (Antlinker.isiOS) {
                try {
                    webkit.messageHandlers.getEffectiveWebkeyPromise.postMessage(JSON.stringify(request));
                } catch (err) {
                ...
                try {
                    androidAntLinker.getEffectiveWebkeyPromise(JSON.stringify(request));
                } catch (err) {
                    Antlinker.getEffectiveWebkeyPromise.reject(err);
                ...
                try {
                    pcAntLinker.getEffectiveWebkeyPromise(JSON.stringify(request));
                } catch (err) {
                    Antlinker.getEffectiveWebkeyPromise.reject(err);
...
export class Antlinker {
    static userAgent: any;
    ...
    public static configPromise: Config;
    static getEffectiveWebkeyPromise: GetEffectiveWebkey;

    static version: string;


    static getSdkVersionPromise () {
