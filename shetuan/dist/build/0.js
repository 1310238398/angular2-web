...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HonorPageModule", function() { return HonorPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__honor__ = __webpack_require__(320);
...
var HonorPageModule = /** @class */ (function () {
    function HonorPageModule() {
    }
    HonorPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__honor__["a" /* HonorPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__honor__["a" /* HonorPage */]),
    ...
    return HonorPageModule;
}());

//# sourceMappingURL=honor.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HonorPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_exif_js__ = __webpack_require__(298);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_exif_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_exif_js__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HonorPage = /** @class */ (function () {
    function HonorPage(navCtrl, http, DomSanitizer, HelpUtils, navParams) {
    ...
    //初始化加载
    HonorPage.prototype.ionViewWillEnter = function () {
    ...
    //初始化加载
    HonorPage.prototype.ionViewDidEnter = function () {
    };
    //总提交
    HonorPage.prototype.tabAlert = function () {
        var _this = this;
        ...
        this.subStop = true;
        this.http.postJSON({
            Router: __WEBPACK_IMPORTED_MODULE_3__app_ServelUrl__["a" /* ServelUrl */].Url.addshetuanhonor,
            Method: 'POST',
            Body: {
                Code: this.UnionCode,
    ...
    //======七牛上传
    HonorPage.prototype.upload = function (obj) {
    ...
    HonorPage.prototype.handleFiles = function (event) {
        var _this = this;
        var file = event.target.files[0];
        var Orientation = null;
        console.log(file, '222222222');
        console.log(file.size, '11111111111');
        __WEBPACK_IMPORTED_MODULE_6_exif_js__["getData"](file, function () {
            // alert(EXIF.pretty(this));
            __WEBPACK_IMPORTED_MODULE_6_exif_js__["getAllTags"](this);
            //alert(EXIF.getTag(this, 'Orientation')); 
            Orientation = __WEBPACK_IMPORTED_MODULE_6_exif_js__["getTag"](this, 'Orientation');
    ...
    //获取上传文件后缀名
    HonorPage.prototype.getFileExtension = function (filename) {
        return filename.slice((filename.lastIndexOf('.') - 1 >>> 0) + 2);
    };
    //删除附件
    HonorPage.prototype.deleteCertify = function (event, index) {
    ...
    // }
    //获取当前时间
    HonorPage.prototype.nowDay = function () {
        var Dates = new Date();
    ...
    HonorPage.prototype.ionViewWillLeave = function () {
