...
export class IndexApplyPage {
  ...
  NavigationTo(obj) {
    ...
    if (obj.flow_code == 'Process_college_good_member' || obj.flow_code == 'Process_college_class_advanced_class_group' || obj.flow_code == 'Process_college_three_good' || obj.flow_code == 'Process_excellent_cadre_at_the_college_level' || obj.flow_code == 'Process_excellent_student_cadre') {
      ...
      this.navCtrl.push('ChangeStatusApplyDetailPage', { dataPass: obj });
    } else if (obj.flow_code == 'Process_StudentChangeClass') {
      this.navCtrl.push('ChangeClassApplyDetailPage', { dataPass: obj });
    } else if (obj.flow_code == 'Process_QingongStudySupport') {
      this.navCtrl.push('QingongUpDetailPage', { dataPass: obj });
      ...
      this.navCtrl.push('PoolStudentApplyDetailPage', { dataPass: obj });
    } else if (obj.flow_code == 'Process_school_activity_apply') {
      this.navCtrl.push('SheTuanUpDetailPage', { dataPass: obj });
    } else if (obj.flow_code == 'Process_SecondClassRoom') {
      this.navCtrl.push('SecondClassUpDetailPage', { dataPass: obj });
    }
