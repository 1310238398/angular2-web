...
antlinker.getNetWorkInfo = function (request) {
  antlinker.getNetWorkInfo.success = request.success;
  antlinker.getNetWorkInfo.fail = request.fail;
  if (antlinker.isiOS) {
    try {
      webkit.messageHandlers.getNetWorkInfo.postMessage(JSON.stringify(request));
    } catch (err) {
      antlinker.getNetWorkInfo.fail(err);
      console.log("iOS getNetWorkInfo not exist");
    }
  } else if (antlinker.isAndroid) {
    try {
      androidAntLinker.getNetWorkInfo(JSON.stringify(request));
    } catch (err) {
      alert(err);
      console.log('err:',err);
      antlinker.getNetWorkInfo.fail(err);
      console.log("Android getNetWorkInfo not exist");
    }
  } else if (antlinker.isPC) {
    try {
      pcAntLinker.getNetWorkInfo(JSON.stringify(request));
    } catch (err) {
      antlinker.getNetWorkInfo.fail(err);
      console.log("Android getNetWorkInfo not exist");
    }
