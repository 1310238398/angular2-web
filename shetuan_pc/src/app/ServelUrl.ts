...
export class ServelUrl {
    ...
    static Url = {
        ...
        getunionteacher: '/api/shetuan/GetUnionTeacher',     //获取指导老师列表
        updateunionteacher: '/api/shetuan/UpdateUnionTeacher',     //获取指导老师列表
        teacherworkinfo: '/api/shetuan/TeacherWorkInfo',     //获取指导老师列表
        getteacherintel: '/api/shetuan/GetTeacherIntel',     //获取指导老师intel
        addunionteacher: '/api/shetuan/AddUnionTeacher',     //获取指导老师列表
        deunionteacher: '/api/shetuan/DeUnionTeacher',     //获取指导老师列表
