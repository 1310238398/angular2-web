...
@Component({
    selector: '',
    templateUrl: './nodocampus.component.html',
    styleUrls: ['./nodocampus.component.css']
})
export class NodoCampusComponent implements OnInit {
    isVisible = false;
    surveyId: string = '';
    dataItem = [];
    Items = [];
    ...
    constructor(public msgSrv: NzMessageService, private confirmServ: NzModalService,  public httpService: HttpService,
         private modalHelper: ModalHelper, private router: ActivatedRoute, private route: Router) {
