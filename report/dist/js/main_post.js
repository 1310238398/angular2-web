...
window.onload = function () {
    ...
    //获取帖子id
    report_post_id  = href_arr[2].split("=")[1];
    report_post_id = parseInt(report_post_id);

    //跳转的uri
    send_uri = href_arr[1] + '?' + href_arr[2];
...
function formState() {
    ...
    if (rubbish == '' && unrealistic == '' && harmful == '' && Illegality == '' && obscene == '' && attack == '' && plagiarism == '' && other == '') {
...
// 点击提交
//function formSend(){
//    if (rubbish == 0 && unrealistic == 0 && harmful == 0 && Illegality == 0 && obscene == 0 && attack == 0 && plagiarism == 0 && other == 0 && detailedContent.value == '') {
//        return;
//    } else {
//
//
...
//    var token = window["__AppWebkey"] || "GZDC1NL1NTCOLQNPRMOJQQ";
