...
@IonicPage()
@Component({
  selector: 'page-indexstudent',
  templateUrl: 'indexstudent.html'
})
export class IndexStudentPage {
  ...
  //跳转到点名页
  NavigationTo(obj) {
    this.navCtrl.push('NameListStudentPage', { dataPass: obj, pagePass: 'index' });
  }
  ...
  //跳转到历史页
  NavtoChange() {
    this.navCtrl.push('HistoryRecordStudentPage');
  }
