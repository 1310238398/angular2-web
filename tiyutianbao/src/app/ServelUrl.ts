export class ServelUrl {
    ...
    static Url = {
        ...
        addhumansociety: '/api/tiyutianbao/addhumansociety',     //插入人社厅表
        querycitytype: ServelUrl.apiPrefix + 'yxinfofill/geographyinit',//获取省市县
        geographyinit: '/api/tiyutianbao/geographyinit',     //获取省市县
        UploadAwardAidFile: '/api/tiyutianbao/UploadAwardAidFile',     //获取省市县GeographyHouse
        geographyhouse: '/api/tiyutianbao/geographyhouse',     //获取户籍地详细省市县
        humansocietyown: '/api/tiyutianbao/humansocietyown',     //获取个人人社厅表
